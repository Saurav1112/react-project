...
{data.filter((item)=>item.cat ==='Technology-Images').map((d,item)=>{
    return(
        ...
        <h3 className="Tech2-Heading">!!!{d.title2}!!!</h3>
        ...
        <div className="Tech2-Media-Container">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXc28Vjal3-9jEdZOGtnVyHNdo4InmpgQo-g&usqp=CAU" alt="Not-Found" className="Tech2-Boy-Logo"/>
            <p className="Tech2-Dimitry">Dimitry Nozhenko</p>
            <p className="Tech2-Date">Jan 28 2019 10 min read</p>
        <img src="https://img.freepik.com/premium-vector/facebook-instagram-twitter-icon_469489-856.jpg" alt="Not-Found"  className="Tech2-Social-Media-Logo"/>
        </div>
