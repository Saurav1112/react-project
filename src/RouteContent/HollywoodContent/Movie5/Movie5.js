...
{data.filter((item)=>item.cat ==='Hollywood-Images').map((d,item)=>{
    return(
        ...
        <h3 className="Movie5-Heading">!!!{d.title5}!!!</h3>
        ...
        <div className="Movie5-Media-Container">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXc28Vjal3-9jEdZOGtnVyHNdo4InmpgQo-g&usqp=CAU" alt="Not-Found" className="Movie5-Boy-Logo"/>
            <p className="Movie5-Dimitry">Dimitry Nozhenko</p>
            <p className="Movie5-Date">Jan 28 2019 10 min read</p>
        <img src="https://img.freepik.com/premium-vector/facebook-instagram-twitter-icon_469489-856.jpg" alt="Not-Found"  className="Movie5-Social-Media-Logo"/>
        </div>
