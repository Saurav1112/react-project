...
{data.filter((item)=>item.cat ==='Fitness-Images').map((d,item)=>{
    return(
        ...
        <h3 className="Fitness8-Heading">!!!{d.title8}!!!</h3>
        ...
        <div className="Fitness8-Media-Container">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXc28Vjal3-9jEdZOGtnVyHNdo4InmpgQo-g&usqp=CAU" alt="Not-Found" className="Fitness8-Boy-Logo"/>
            <p className="Fitness8-Dimitry">Dimitry Nozhenko</p>
            <p className="Fitness8-Date">Jan 28 2019 10 min read</p>
        <img src="https://img.freepik.com/premium-vector/facebook-instagram-twitter-icon_469489-856.jpg" alt="Not-Found"  className="Fitness8-Social-Media-Logo"/>
        </div>
